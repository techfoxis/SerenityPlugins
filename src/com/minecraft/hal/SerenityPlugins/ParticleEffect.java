...
import com.minecraft.hal.SerenityPlugins.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	 ...
	 * <ul>
	 * <li>It looks like a little gray butt
	 * <li>The speed value influences the velocity at which the particle flies off
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>It looks like a large gray butt
	 * <li>The speed value influences the velocity at which the particle flies off
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>It looks like a purple butt
	 ...
	 * <ul>
	 * <li>It looks like a large white butt
	 * <li>The speed value influences the velocity at which the particle flies off
	 * </ul>
	 */
	Butt("butt", 29, -1),
	 ...
	 * <ul>
	 * <li>It looks like a tiny colored butt
	 ...
	 * A particle effect which is currently unused:
	 * <ul>
	 * <li>It looks like a tiny white butt
	 * <li>The speed value influences the velocity at which the particle flies off
	 * </ul>
	 */
